    ...
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item" href="https://www.nobleui.com/html/template/demo1/dashboard.html">
      ...
      <nav class="navbar">
            ...
            <!-- FEEDBACK -->
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
								<div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
									<a href="feedback.php" <?=(basename($_SERVER['PHP_SELF']) == "feedback.php")? "active":""; ?>><p>Feedback</p></a>
            ...
            <!-- NOTIFICATION -->
              ...
              <?php if(!$cphoto): ?>
								<img class="wd-30 ht-30 rounded-circle" src="assets/images/others/profile-cover.png" alt="profile">
                <?php else: ?>
                  <img src="<?= 'php/'.$cphoto; ?>" class="wd-30 ht-30 rounded-circle" alt="profile">
                          <?php endif; ?>
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
                  <?php if(!$cphoto): ?>
										<img class="wd-80 ht-80 rounded-circle" src="assets/images/others/profile-cover.png" alt="">
                    <?php else: ?>
                      <img src="<?= 'php/'.$cphoto; ?>" class="rounded-circle" height="80" width="80" alt="profile">
                          <?php endif; ?>
									</div>
									<div class="text-center">
										<p class="tx-16 fw-bolder">&nbsp;Hi! <?= $fname; ?></p>
										<p class="tx-12 text-muted"><?= $cemail; ?></p>
                   
									</div>
								</div>
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="profile.php" class="text-body ms-0" <?=(basename($_SERVER['PHP_SELF']) == "profile.php")? "active":""; ?>>
                      <i class="me-2 icon-md" data-feather="user"></i>
                      <span>Profile</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
                    <a href="edit_profile.php" class="text-body ms-0" <?=(basename($_SERVER['PHP_SELF']) == "edit_profile.php")? "active":""; ?>>
                  ...
                  <li class="dropdown-item py-2">
                    <a href="php/logout.php" class="text-body ms-0">
